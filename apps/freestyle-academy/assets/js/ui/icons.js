...
const PATHS = {
  ...
  lock: P('M7 11V8a5 5 0 0 1 10 0v3M6 11h12a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1v-8a1 1 0 0 1 1-1Z'),
  drag: P('M9 6h.01M9 12h.01M9 18h.01M15 6h.01M15 12h.01M15 18h.01'),
  music: P('M9 18V5l12-2v13M9 18a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM21 16a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z'),
  skip: P('M5 4l10 8-10 8V4ZM19 5v14'),
  volume: P('M11 5L6 9H3v6h3l5 4V5Z'),
  mute: P('M11 5L6 9H3v6h3l5 4V5ZM22 9l-6 6M16 9l6 6'),
  shuffle: P('M16 3h5v5M4 20 21 3M21 16v5h-5M15 15l6 6M4 4l5 5'),
  users: P('M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8ZM23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75'),
  sparkles: P('M12 3l1.9 5.6L19.5 10l-5.6 1.9L12 17.5l-1.9-5.6L4.5 10l5.6-1.4L12 3ZM19 16l.8 2.2L22 19l-2.2.8L19 22l-.8-2.2L16 19l2.2-.8L19 16Z'),
  mail: P('M3 7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7ZM3 7l9 6 9-6'),
  eye: P('M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7ZM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z'),
  shield: P('M12 3l8 3v6c0 5-3.4 8.3-8 9-4.6-.7-8-4-8-9V6l8-3Z'),
  bug: P('M8 6a4 4 0 0 1 8 0M5 10h14M6 10v4a6 6 0 0 0 12 0v-4M3 13h3M18 13h3M4.5 7.5 7 9M19.5 7.5 17 9M4.5 18.5 7 17M19.5 18.5 17 17'),
  doc: P('M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8l-5-5ZM14 3v5h5M9 13h6M9 17h4'),
